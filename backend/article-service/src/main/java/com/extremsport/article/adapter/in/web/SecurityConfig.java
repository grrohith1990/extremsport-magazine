    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/articles/public/**", "/api/v1/articles/search", "/api/v1/articles/archive").permitAll()
                        .requestMatchers(org.springframework.http.HttpMethod.GET, "/api/v1/articles/{id}").permitAll()
