...
var AuthGuard = class _AuthGuard {
  ...
  canActivate(route) {
    return __async(this, null, function* () {
      const isLoggedIn = yield this.keycloakService.isLoggedIn();
      if (!isLoggedIn) {
        yield this.keycloakService.login({
      ...
      if (requiredRoles && requiredRoles.length > 0) {
        const userRoles = yield this.keycloakService.getUserRoles();
  ...
  static {
    this.\u0275fac = function AuthGuard_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _AuthGuard)(\u0275\u0275inject(KeycloakService), \u0275\u0275inject(Router));
    };
  }
  static {
...
js-sha256/src/sha256.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-B24JZZKN.js.map
